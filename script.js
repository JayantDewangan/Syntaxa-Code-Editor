...
<section class="card" style="max-width: 520px; margin:24px auto; padding:18px;text-align:center">
    <h1>Welcome to Syntaxa- Your own personalised code Editor.</h1>
...
const lightLogoSrc = './assets/logo_light.png';
const darkLogoSrc = './assets/logo_dark.png';
const lightToggleSrc = './assets/light-mode.png';
